...
{/foreach}
    ...
    * @Apidoc\Method("POST")
    * @Apidoc\Param (ref="app\model\{$tables[1].model_name}\getInfoById",withoutField="id")
    * @Apidoc\Returned (ref="app\model\{$tables[1].model_name}\getInfoById")
    */
    ...
    * @Apidoc\Method("GET")
    * @Apidoc\Param ("{$form.relation_field}",type="int",desc="{$tables[0].table_comment}id")
    * @Apidoc\Returned(ref="pagingParam")
    * @Apidoc\Returned (ref="app\model\{$tables[1].model_name}\getInfoById",type="array")
    */
