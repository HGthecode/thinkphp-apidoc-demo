...
class ApiDoc
{
    ...
    /**
     * @Returned("user_data", type="array", ref="app\admin\services\ApiDoc\getRefUserList",desc="关联用户数据")
     * @Returned("info", type="object", ref="app\admin\services\ApiDoc\getUserInfo",desc="用户信息")
     */
